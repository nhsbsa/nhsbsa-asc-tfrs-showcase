...
<GridRow>
    <GridColumn width={'2/3'}>
        <LeadParagraph>
            These recommendations are based on insights from multiple sources and aim to add value both to this project and others within the adult social care space.
        </LeadParagraph>
    </GridColumn>
...
<GridRow>
    ...
    <GridColumn width={'3/4'}>
        ...
        <Details title={'Pragmatic decisions should be made about how to provide the most early value in private beta from both a user and policy perspective'}>
        ...
        <Details title={'For future projects it would be worth looking at how project phases and teams are set up to better bridge the gaps we experienced on TFRS'}>
        ...
        <Details title={'Developing policy more iteratively, collaboratively and using a human centred approach could de-risk project delivery'}>
            ...
            It’s also important to include NHSBSA as the delivery partner more closely in policy development, for similar reasons. A more iterative, collaborative approach would lead to better policy in shorter timescales.
        </Details>

        ## Recommendation 4

        <Details title={'Time and money should be set aside in early beta to focus on creating an accessible and inclusive service'}>
            ecruitment challenges and time pressures meant we could not focus as much as we wanted to on accessibility during alpha, though obviously our prototype is built using GDS accessible patterns and components.
        ...
        <Details title={'It’s important to focus strategically as well as tactically when delivering services to understand the wider landscape and the best ways of aligning services and approaches'}>
        ...
        <Details title={'We should make sure we’re not losing anything important when transitioning from WDF to TFRS'}>
        ...
        <Details title={'Further research would be useful into the types of training covered by TFRS and the impact on both ASC employers and on the aims of the fund if things like internal training are not included'}>
        ...
        <Details title={'Recruitment for UR sessions is extremely challenging and a piece of work across NHSBSA and DHSC to identify effective future approaches would be  useful'}>
...
<GridRow>
    <GridColumn width={'1/2'}>
        <LinkBlock style="prev" url="/assumptions/assumption-4" title="Challenging our riskiest assumptions" text="Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus" />
    </GridColumn>
    <GridColumn width={'1/2'}>
