---
title: Assumption 1 | ASC-TFRS Alpha Showcase
...
<GridRow>
    <GridColumn width={'1/2'}>
        <LinkBlock style="prev" url="/assumptions/assumptions-overview" title="Challenging our riskiest assumptions" text="Assumptions Overview" />
    </GridColumn>
    <GridColumn width={'1/2'}>
